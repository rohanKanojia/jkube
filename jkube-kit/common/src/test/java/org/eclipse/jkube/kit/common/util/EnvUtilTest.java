...
class EnvUtilTest {
    ...
    void isProcessorArchitectureARM_whenSystemPropertyProvided_thenReturnExpectedResult(String osArchPropertyValue, boolean result) {
        try {
            // Given
            ...
            // When + Then
            assertThat(EnvUtil.isProcessorArchitectureARM()).isEqualTo(result);
        } finally {
